...
namespace Nestly.Infrastructure.Migrations
{
    ...
    [Migration("20260910143334_AddSlotWindowCityActiveIndex")]
    partial class AddSlotWindowCityActiveIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nestly.Domain.AmcPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int>("VisitsIncluded")
                        .HasColumnType("integer")
                        .HasColumnName("visits_included");

                    b.HasKey("Id")
                        .HasName("pk_amc_plan");

                    b.HasIndex("CategoryId")
                        .HasDatabaseName("ix_amc_plan_category_id");

                    b.HasIndex("Name")
                        .IsUnique()
                        .HasDatabaseName("ix_amc_plan_name");

                    b.ToTable("amc_plan", (string)null);
                });

            modelBuilder.Entity("Nestly.Domain.AmcServiceVisit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_amc_service_visit");

                    b.HasIndex("BookingId")
                        .IsUnique()
                        .HasDatabaseName("ix_amc_service_visit_booking_id");

                    b.HasIndex("ContractId")
                        .HasDatabaseName("ix_amc_service_visit_contract_id");

                    b.ToTable("amc_service_visit", (string)null);
                });
            ...
            modelBuilder.Entity("Nestly.Domain.Booking", b =>
                {
                    ...
                    b.Property<bool>("IsDurationBasedSnapshot")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                    ...
                    b.Property<int>("ServiceDurationMinutesSnapshot")
                        ...
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("service_duration_minutes_snapshot");
                    ...
                    b.HasIndex("AmcContractId")
                        .HasDatabaseName("ix_booking_amc_contract_id");
                    ...
                    b.HasIndex("BookingReference")
                        .IsUnique()
                        .HasDatabaseName("ix_booking_booking_reference");
                    ...
                    b.HasIndex("Status", "SlotDate")
                        .HasDatabaseName("ix_booking_status_slot_date");
            ...
            modelBuilder.Entity("Nestly.Domain.BookingItem", b =>
                {
                    ...
                    b.Property<string>("ServiceGroupNameSnapshot")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("service_group_name_snapshot");
            ...
            modelBuilder.Entity("Nestly.Domain.Category", b =>
                {
                    ...
                    b.Property<string>("PageBannerUrl")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("page_banner_url");
                    ...
                    b.HasIndex("CategoryGroupId")
                        .HasDatabaseName("ix_category_category_group_id");
            ...
            modelBuilder.Entity("Nestly.Domain.CategoryGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_category_group");

                    b.HasIndex("CategoryId")
                        .HasDatabaseName("ix_category_group_category_id");

                    b.ToTable("category_group", (string)null);
                });
            ...
            modelBuilder.Entity("Nestly.Domain.CustomerAmcContract", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<DateTime?>("ExpiringSoonNotifiedForEndDateUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("expiring_soon_notified_for_end_date_utc");
                    ...
                    b.Property<int>("TermMonthsSnapshot")
                        .HasColumnType("integer")
                        .HasColumnName("term_months_snapshot");

                    b.Property<int>("VisitsIncludedSnapshot")
                        .HasColumnType("integer")
                        .HasColumnName("visits_included_snapshot");

                    b.Property<int>("VisitsRemaining")
                        .HasColumnType("integer")
                        .HasColumnName("visits_remaining");

                    b.HasKey("Id")
                        .HasName("pk_customer_amc_contract");

                    b.HasIndex("CustomerId")
                        .HasDatabaseName("ix_customer_amc_contract_customer_id");

                    b.HasIndex("EndDateUtc")
                        .HasDatabaseName("ix_customer_amc_contract_end_date_utc");

                    b.HasIndex("PaymentTransactionId")
                        .HasDatabaseName("ix_customer_amc_contract_payment_transaction_id");

                    b.HasIndex("Status")
                        .HasDatabaseName("ix_customer_amc_contract_status");

                    b.ToTable("customer_amc_contract", (string)null);
                });
            ...
            modelBuilder.Entity("Nestly.Domain.LandingSelection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_landing_selection");

                    b.HasIndex("SectionType", "SortOrder")
                        .HasDatabaseName("ix_landing_selection_section_type_sort_order");

                    b.HasIndex("SectionType", "CategoryId", "SortOrder")
                        .HasDatabaseName("ix_landing_selection_section_type_category_id_sort_order");

                    b.ToTable("landing_selection", (string)null);
                });
            ...
            modelBuilder.Entity("Nestly.Domain.Provider", b =>
                {
                    ...
                    b.HasIndex("ReferralCode")
                        .IsUnique()
                        .HasDatabaseName("ix_provider_referral_code")
                        .HasFilter("referral_code IS NOT NULL");
            ...
            modelBuilder.Entity("Nestly.Domain.ProviderReferral", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int>("QualifyingCompletedJobsCount")
                        .HasColumnType("integer")
                        .HasColumnName("qualifying_completed_jobs_count");

                    b.Property<Guid?>("RefereeEarningEntryId")
                        .HasColumnType("uuid")
                        .HasColumnName("referee_earning_entry_id");

                    b.Property<Guid>("RefereeProviderId")
                        .HasColumnType("uuid")
                        .HasColumnName("referee_provider_id");
                    ...
                    b.Property<Guid?>("ReferrerEarningEntryId")
                        .HasColumnType("uuid")
                        .HasColumnName("referrer_earning_entry_id");

                    b.Property<Guid>("ReferrerProviderId")
                        .HasColumnType("uuid")
                        .HasColumnName("referrer_provider_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_provider_referral");

                    b.HasIndex("IsFraudFlagged")
                        .HasDatabaseName("ix_provider_referral_is_fraud_flagged");

                    b.HasIndex("RefereeProviderId")
                        .IsUnique()
                        .HasDatabaseName("ix_provider_referral_referee_provider_id");

                    b.HasIndex("ReferrerProviderId")
                        .HasDatabaseName("ix_provider_referral_referrer_provider_id");

                    b.HasIndex("Status")
                        .HasDatabaseName("ix_provider_referral_status");

                    b.HasIndex("Status", "ExpiresAtUtc")
                        .HasDatabaseName("ix_provider_referral_status_expires_at_utc");

                    b.ToTable("provider_referral", (string)null);
                });

            modelBuilder.Entity("Nestly.Domain.ProviderReferralProgramConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int?>("MaxReferralsPerProvider")
                        .HasColumnType("integer")
                        .HasColumnName("max_referrals_per_provider");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_provider_referral_program_config");

                    b.ToTable("provider_referral_program_config", (string)null);
                });
            ...
            modelBuilder.Entity("Nestly.Domain.RecurringBookingPlan", b =>
                {
                    ...
                    b.Property<bool>("ApplyWalletCredit")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
            ...
            modelBuilder.Entity("Nestly.Domain.Service", b =>
                {
                    ...
                    b.Property<bool>("IsDurationBased")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("is_duration_based");
            ...
            modelBuilder.Entity("Nestly.Domain.AmcPlan", b =>
                {
                    b.HasOne("Nestly.Domain.Category", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_amc_plan_category_category_id");
                });
            ...
            modelBuilder.Entity("Nestly.Domain.AmcServiceVisit", b =>
                {
                    b.HasOne("Nestly.Domain.Booking", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_amc_service_visit_bookings_booking_id");

                    b.HasOne("Nestly.Domain.CustomerAmcContract", null)
                        .WithMany()
                        .HasForeignKey("ContractId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_amc_service_visit_customer_amc_contracts_contract_id");
                });
            ...
            modelBuilder.Entity("Nestly.Domain.Booking", b =>
                {
                    b.HasOne("Nestly.Domain.CustomerAmcContract", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_booking_customer_amc_contracts_amc_contract_id");
            ...
            modelBuilder.Entity("Nestly.Domain.Category", b =>
                {
                    b.HasOne("Nestly.Domain.CategoryGroup", null)
                        .WithMany()
                        .HasForeignKey("CategoryGroupId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_category_category_group_category_group_id");
            ...
            modelBuilder.Entity("Nestly.Domain.CustomerAmcContract", b =>
                {
                    b.HasOne("Nestly.Application.Customer", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_customer_amc_contract_customer_customer_id");
